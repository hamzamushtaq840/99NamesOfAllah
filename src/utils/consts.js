...
export const accordions = [
  ...
  },
  {
    ...
    content: (
      <p className="list-decimal flex flex-col">
        ...
        <br />
        <br />
        <span><span className="text-white font-[800] underline">Consistency:</span> Allocate a specific time daily for memorization. Consistency is vital in retaining the names for a long time.</span>
        <span><span className="text-white font-[800] underline">Chunking:</span> Break the names into smaller groups, perhaps focusing on 10-15 names at a time. Gradually add more names as you become comfortable.</span>
        <span><span className="text-white font-[800] underline">Understanding:</span> Learn the meanings and attributes associated with each name. This aids memorization and deepens your connection to Allah&rsquo;s qualities.</span>
        <span><span className="text-white font-[800] underline">Recitation:</span> Repeat the names aloud. Hearing and speaking the names reinforces the memory.</span>
        <span><span className="text-white font-[800] underline">Flashcards:</span> Create flashcards with the name on one side and the meaning on the other. Review them on regular bases.</span>
        <span><span className="text-white font-[800] underline">Supplication:</span>  Incorporate the names into your daily supplication, deepening your connection with Allah while revising them.</span>
        <span><span className="text-white font-[800] underline">Patience:</span> Memorization takes time. Be patient and persistent in your efforts.</span>
        <br />
