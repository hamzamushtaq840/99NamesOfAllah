export const names = [
  ...
  },
  {
    ...
    englishName: 'AL-KHAAFID',
    meaning: 'The Abaser'
  },
  {
    image: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
    imageBrightness: '40%',
    arabicName: 'ٱلْرَّافِعُ',
    englishName: 'AR-RAAFI’',
    meaning: 'The Exalter'
  },
  {
    image: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
  ...
  },
  {
    image: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
    imageBrightness: '40%',
    arabicName: 'ٱلْوَلِىُّ',
    englishName: 'AL-WALEE',
  ...
  },
  {
    image: 'https://images.unsplash.com/photo-1600298881974-6be191ceeda1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
    imageBrightness: '40%',
    arabicName: 'ٱلْمُحْيِى',
    englishName: 'AL-MUHYEE',
...
export const accordions = [
  ...
  },
  {
    ...
    content: (
      <>
        ...
        In essence, the 99 Names of Allah are like facets of a divine gem, refracting the light of His attributes onto the hearts of believers, enriching their faith, and guiding them on their journey.
      </>
    )
  },
  {
  ...
  },
  {
    ...
    content: 'Lorem ipsum  99 Names of Allah, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.',
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-decimal flex flex-col gap-2 ml-6">
          ...
          <li className="mb-3">Utilize Audio Resources: Listen to recitations by scholars to learn proper pronunciation and rhythm.</li>
          <li className="mb-3">Reflect and Meditate: Reflect on the qualities each name represents and meditate on their relevance in your life.</li>
          <li className="mb-3">Teach Others: Sharing your knowledge helps reinforce your memory and inspires others.</li>
          <li className="mb-3">Seek Divine Assistance: Supplicate to Allah for guidance and ease in memorization. Trust in His support.</li>
          <li>Patience and Persistence: Memorization is a gradual process. Exercise patience and persist even when it feels challenging.</li>
        </ul>

        <p>Remember, the objective is not just memorization, but also internalizing the attributes of Allah. Approach this endeavor with sincerity and humility, and let the names of Allah become a guiding light in your spiritual journey.</p>
      </>
    )
  }
]