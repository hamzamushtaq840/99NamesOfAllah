...
export async function generateMetadata({ params }) {
  const name = names.find(val => {
    return val.english.name.toLocaleLowerCase() === params.id.toLocaleLowerCase()
  })
  return {
...
const SingleName = async ({ params }) => {
  ...
  return (
    <div className="flex min-h-[100vh] flex-col items-center bg-[#252836]">
      <Hero name={name} />
    </div>
  )
}
