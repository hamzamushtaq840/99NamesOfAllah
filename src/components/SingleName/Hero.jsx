          ...
          <div className="mt-4 flex flex-col gap-6">
            {name?.singlePageData?.quranMentions?.map((val, index) => {
              if (val.contentType === 'text')
                return <p className="outfit text-justify text-[18px] leading-[28px] text-[#c5ccd3]">{val.content}</p>
              else
                return (
